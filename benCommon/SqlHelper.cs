...
namespace JominyPredict
{
    ...
    {
        //读取配置文件里的数据库连接字符串
        public static readonly string connStr = ConfigurationManager.ConnectionStrings["JominyPredict.Properties.Settings.jominyDBConnectionString"].ConnectionString;
